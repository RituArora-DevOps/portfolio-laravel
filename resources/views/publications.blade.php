    ...
    <main class="flex-grow-1">
        <section id="video" class="text-center my-4">
            ...
            <iframe width="811" height="232" src="https://www.youtube.com/embed/5K8SDzdNbsg"
                title="{{ __('publications.video_heading') }}" style="border: none;"
        ...
        <section class="container my-4">
            ...
            <ul class="list-unstyled">
                ...
                <li>
                    ...
                    <a href="link-to-publication-1" target="_blank" rel="noopener noreferrer">
                        <em>Novel 1-triazolylpyranopyrazoles as highly potent anticancer & promising antibacterial agents
                            obtained via MW-assisted synthesis</em>
                ...
                <li>
                    ...
                    <a href="link-to-publication-2" target="_blank" rel="noopener noreferrer">
                        <em>Design, Synthesis and Evaluation of 1 H -1,2,3-Triazol-4-yl-methyl Tethered 3-Pyrrolylisatins as
                            Potent Anti-Breast Cancer Agents</em>
            ...
            <button class="btn btn-primary toggleButton" data-bs-toggle="collapse"
                data-bs-target="#additional-publications">
                ...
                <ul class="list-unstyled">
                    ...
                    <li>
                        ...
                        <a href="link-to-publication-5" target="_blank" rel="noopener noreferrer">
                            <em>Synthesis, pharmacological evaluation and molecular docking of pyranopyrazole linked
                                1,4-dihydropyridines as potent positive inotropes</em>
                    ...
                    <li>
                        ...
                        <a href="link-to-publication-8" target="_blank" rel="noopener noreferrer">
                            <em>Theoretical study of the mechanism of the Wolff rearrangement of some diazocarbonyl
                                compounds</em>
                    ...
                    <li>
                        ...
                        <a href="link-to-publication-10" target="_blank" rel="noopener noreferrer">
                            <em>Theoretical study of the stability of tautomers and conformers of isatin-3-thiosemicarbazone
                                (IBT)</em>
