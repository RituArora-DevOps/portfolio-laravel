...
<main class="flex-grow-1 container py-5">
    <section id="projects">
        ...
        <div class="row">
            @include('partials.project-card', ['image' => 'project-jenkins.jpg', 'title' => __('projects.jenkins.title'), 'desc' => __('projects.jenkins.desc')])
            @include('partials.project-card', ['image' => 'Project-docker.jpg', 'title' => __('projects.docker.title'), 'desc' => __('projects.docker.desc')])
            @include('partials.project-card', ['image' => 'project-aws.jpg', 'title' => __('projects.aws.title'), 'desc' => __('projects.aws.desc')])
            @include('partials.project-card', ['image' => 'project-prometheus.jpg', 'title' => __('projects.prometheus.title'), 'desc' => __('projects.prometheus.desc')])
            @include('partials.project-card', ['image' => 'project-k8s.jpg', 'title' => __('projects.k8s.title'), 'desc' => __('projects.k8s.desc')])
        </div>

        <h2 class="mt-5">{{ __('projects.cadd_heading') }}</h2>
        <div class="row">
            @include('partials.project-card', ['image' => 'project-3d.jpg', 'title' => __('projects.cadd3d.title'), 'desc' => __('projects.cadd3d.desc')])
            @include('partials.project-card', ['image' => 'project-qsar.jpg', 'title' => __('projects.qsar.title'), 'desc' => __('projects.qsar.desc')])
            @include('partials.project-card', ['image' => 'project-virtual.jpg', 'title' => __('projects.virtual.title'), 'desc' => __('projects.virtual.desc')])
            @include('partials.project-card', ['image' => 'project-pharma.jpg', 'title' => __('projects.pharma.title'), 'desc' => __('projects.pharma.desc')])
        </div>
    </section>
