...
<section id="projects" class="container py-5" aria-labelledby="projects-heading">
  ...
  <div id="featuredProjectsCarousel" class="carousel slide" data-bs-ride="carousel">
    <div class="carousel-inner">
      ...
      <div class="carousel-item active">
        <div class="card project-card">
          <img src="{{ asset('images/project-car-rental.PNG') }}" class="card-img-top" alt="Car Rental Management System" />
          <div class="card-body">
      ...
      <div class="carousel-item">
        <div class="card project-card">
          <img src="{{ asset('images/project-portfolio.PNG') }}" class="card-img-top" alt="Personal Portfolio Screenshot" />
          <div class="card-body">
    ...
    <!-- Carousel Controls -->
    <button class="carousel-control-prev" type="button" data-bs-target="#featuredProjectsCarousel" data-bs-slide="prev" aria-label="Previous Project">
      <span class="carousel-control-prev-icon" aria-hidden="true"></span>
      <span class="visually-hidden">{{ __('home.previous') }}</span>
    </button>
    <button class="carousel-control-next" type="button" data-bs-target="#featuredProjectsCarousel" data-bs-slide="next" aria-label="Next Project">
